...
public class InventarioActivity extends AppCompatActivity {
    ...
    private void exportarPDF() {
        ...
        y += 20;
        canvas.drawLine(40, y, 550, y, paint); // Línea separadora
        y += 20;

        // Imprimir cada producto en el PDF
        for (int i = 0; i < adapter.getCount(); i++) {
            Producto p = adapter.getItem(i);

            // Acortar textos muy largos para que no se encima la tabla
            ...
            // Si llegamos al final de la hoja, creamos otra nueva
        ...
        // Guardar el archivo en la carpeta "Documentos" del celular
