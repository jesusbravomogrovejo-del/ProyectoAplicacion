...
public class DashboardActivity extends AppCompatActivity {
    ...
    private PieChartView pieChart; // VARIABLE DEL GRÁFICO
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pieChart = findViewById(R.id.pieChart); // CONEXIÓN DEL GRÁFICO
        ...
        if (ivCerrarSesion != null) {
            ivCerrarSesion.setOnClickListener(v -> {
                ...
                // Borra el historial de pantallas para que no puedan volver con el botón "Atrás"
        ...
        lvProductos.setOnItemClickListener((parent, view, position, idItem) -> {
            ...
            TextView tvStock = dialog.findViewById(R.id.tvDialogStock); // CONECTAMOS EL TEXTVIEW DEL STOCK
            ...
            // ENVIAMOS EL DATO DE LA CANTIDAD AL CUADRO
            if (tvStock != null) {
    ...
    private void cargarMetricasYLista() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                if (fechaCaducidad != null && !fechaCaducidad.isEmpty() && !"00.00.0000".equals(fechaCaducidad)) {
                    try {
                        ...
                        if (fecha != null) {
                            ...
                            // --- LÓGICA CORREGIDA PARA LAS CAJITAS ---
                            if (diasRestantes == 0) vencenHoy++; // Solo los que vencen exactamente hoy
                            else if (diasRestantes > 0 && diasRestantes <= 7) vencenSemana++; // Solo los futuros hasta 7 días
                        }
                ...
                // Sumamos a los contadores del gráfico según el estado
        ...
        // Enviamos los datos al gráfico para que se dibuje
        if (pieChart != null) {
